...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,employeeNo,name,email,phone,position,dept,photoUrl,role);

@override
String toString() {
  return 'AppUser(id: $id, employeeNo: $employeeNo, name: $name, email: $email, phone: $phone, position: $position, dept: $dept, photoUrl: $photoUrl, role: $role)';
}
